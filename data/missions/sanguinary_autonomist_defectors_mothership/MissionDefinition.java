package data.missions.sanguinary_autonomist_defectors_mothership;
...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_MotherShip_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_MotherShip_FrontSide_Standard", FleetMemberType.SHIP, true);
