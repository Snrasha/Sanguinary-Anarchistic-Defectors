package data.missions.sanguinary_autonomist_defectors_classic;
...
public class MissionDefinition implements MissionDefinitionPlugin {
    ...
    public void defineMission(MissionDefinitionAPI api) {
        ...
        //api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Atan_Standard", FleetMemberType.SHIP, true);
       // api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Atan_b_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Babi_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Apis_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Hapy_Burst", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Imhotep_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Khonsu_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Maat_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Owclaw_Attack", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Neith_Missile", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Qadesh_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Tefnut_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Ptah_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Seshat_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Taweret_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Thoth_Missile", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Hathor_Standard", FleetMemberType.SHIP, true);
        api.addToFleet(FleetSide.PLAYER, "sanguinary_autonomist_defectors_Osiris_Standard", FleetMemberType.SHIP, true);
