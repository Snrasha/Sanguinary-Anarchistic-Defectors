...
public class SAD_SimpleMissileAI implements MissileAIPlugin, GuidedMissileAI
{
  ...
  public SAD_SimpleMissileAI(MissileAPI missile, ShipAPI launchingShip)
  {
  ...
  public CombatEntityAPI assignTarget(MissileAPI missile)
  {
    ...
    {
      if (MathUtils.getShortestRotation(missile.getFacing(), VectorUtils.getAngle(missile.getLocation(), currentTarget.getLocation())) < 15.0F)
      {
    ...
    for (ShipAPI tmp : AIUtils.getNearbyEnemies(missile, 2000.0F))
    {
      ...
      if (MathUtils.getShortestRotation(missile.getFacing(), VectorUtils.getAngle(missile.getLocation(), tmp.getLocation())) <= 10.0F)
      {
