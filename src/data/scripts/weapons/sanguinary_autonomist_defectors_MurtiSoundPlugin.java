...
public class sanguinary_autonomist_defectors_MurtiSoundPlugin implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (charging) {
            ...
            charging = true;
            //Global.getSoundPlayer().playSound("sanguinary_autonomist_defectors_slowBeamM_charge", 0.5F, 0.5F, point1, weapon.getShip().getVelocity());
        }
