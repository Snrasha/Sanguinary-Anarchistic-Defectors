...
public class SAD_AssignmentAI implements EveryFrameScript {
	...
	public SAD_AssignmentAI(CampaignFleetAPI fleet, StarSystemAPI homeSystem, SectorEntityToken source) {
		this.fleet = fleet;
	...
	protected void giveInitialAssignments() {
		...
		if ((playerInSameLocation || (float) Math.random() < 0.1f) && source != null) {
			...
			SectorEntityToken target = SAD_SeededFleetManager.pickEntityToGuard(new Random(), homeSystem, fleet);
			if (target != null) {
