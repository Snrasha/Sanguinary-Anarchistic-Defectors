...
import src.data.scripts.campaign.raid.SAD_raidManager.PunExData;

public class SAD_AvertInteractionDialogPluginImpl implements InteractionDialogPlugin {
	...
	public SAD_AvertInteractionDialogPluginImpl(SAD_raidIntel intel, IntelUIAPI ui) {
		this.intel = intel;
		this.ui = ui;
	}
	...
	protected int computeBribeAmount() {
		PunExData data = SAD_raidManager.getInstance().dataPun;
...
//		return bribe;
	...
	public void optionSelected(String text, Object optionData) {
		...
		case CONFIRM:
			...
			intel.sendUpdate(SAD_raidIntel.OUTCOME_UPDATE, textPanel);
			addDismissOption();
			break;
		case CANCEL:
			addChoiceOptions();
