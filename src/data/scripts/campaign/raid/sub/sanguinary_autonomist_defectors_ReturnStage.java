...
public class sanguinary_autonomist_defectors_ReturnStage extends sanguinary_autonomist_defectors_BaseRaidStage {

	public sanguinary_autonomist_defectors_ReturnStage(sanguinary_autonomist_defectors_raidIntel raid) {
		super(raid);
	}
