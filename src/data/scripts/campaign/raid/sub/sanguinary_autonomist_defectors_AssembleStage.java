...
public class sanguinary_autonomist_defectors_AssembleStage extends sanguinary_autonomist_defectors_BaseRaidStage {
    ...
    public sanguinary_autonomist_defectors_raidIntel raid;
    ...
    public sanguinary_autonomist_defectors_AssembleStage(sanguinary_autonomist_defectors_raidIntel raid, SectorEntityToken gatheringPoint) {
        super(raid);
        this.intel = raid;
    ...
    protected void addRoutesAsNeeded(float amount) {
        ...
        sanguinary_autonomist_defectors_OptionalFleetData extra = new sanguinary_autonomist_defectors_OptionalFleetData();
        extra.quality = 5f;
        extra.factionId = "sad";

        String sid = intel.getRouteSourceId();
        RouteData route = sanguinary_autonomist_defectors_RouteManager.getInstance().addRoute(sid, gatheringPoint, Misc.genRandomSeed(), extra, raid, null);
