...
import src.data.scripts.campaign.raid.sanguinary_autonomist_defectors_raidIntel.PunExOutcome;
import src.data.scripts.campaign.raid.sanguinary_autonomist_defectors_raidManager.PunExData;

public class sanguinary_autonomist_defectors_AvertInteractionDialogPluginImpl implements InteractionDialogPlugin {
	...
	public static float REP_COST  = 0.25f;
	...
	protected sanguinary_autonomist_defectors_raidIntel intel;
	protected IntelUIAPI ui;
	
	public sanguinary_autonomist_defectors_AvertInteractionDialogPluginImpl(sanguinary_autonomist_defectors_raidIntel intel, IntelUIAPI ui) {
		this.intel = intel;
		this.ui = ui;
	}
	...
	protected int computeBribeAmount() {
		PunExData data = sanguinary_autonomist_defectors_raidManager.getInstance().dataPun;
...
//		return bribe;
	...
	public void optionSelected(String text, Object optionData) {
		...
		case CONFIRM:
			...
			intel.sendUpdate(sanguinary_autonomist_defectors_raidIntel.OUTCOME_UPDATE, textPanel);
			addDismissOption();
			break;
		case CANCEL:
			addChoiceOptions();
