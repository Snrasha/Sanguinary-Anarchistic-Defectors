...
public class sanguinary_autonomist_defectors_RaidAssignmentAI extends BaseAssignmentAI implements FleetActionTextProvider {
       protected RouteData route;
	protected Boolean gaveReturnAssignments = null;


	public sanguinary_autonomist_defectors_RaidAssignmentAI(CampaignFleetAPI fleet, RouteData route, FleetActionDelegate delegate) {
            		super();
	...
	public sanguinary_autonomist_defectors_RaidAssignmentAI(CampaignFleetAPI fleet, RouteData route) {
		super();
		this.fleet = fleet;
		this.route = route;
		giveInitialAssignments();
...
//		fleet.setLocation(loc.x, loc.y);
	...
	public void advance(float amount) {
		...
		if (curr != null && 
				(
					sanguinary_autonomist_defectors_BaseRaidStage.STRAGGLER.equals(route.getCustom()) || 
					sanguinary_autonomist_defectors_AssembleStage.WAIT_STAGE.equals(curr.custom) || 
					curr.isTravel())) {
	...
	protected String getInSystemActionText(RouteSegment segment) {
		if (sanguinary_autonomist_defectors_AssembleStage.WAIT_STAGE.equals(segment.custom)) {
	...
	protected String getStartingActionText(RouteSegment segment) {
		if (sanguinary_autonomist_defectors_AssembleStage.PREP_STAGE.equals(segment.custom)) {
			String s = null;
