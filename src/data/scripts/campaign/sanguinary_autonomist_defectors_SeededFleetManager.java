...
public class sanguinary_autonomist_defectors_SeededFleetManager extends SeededFleetManager {
    ...
    public static class sanguinary_autonomist_defectors_FleetInteractionConfigGen implements FIDConfigGen {
    ...
    public sanguinary_autonomist_defectors_SeededFleetManager(StarSystemAPI system, int minFleets, int maxFleets, int minPts, int maxPts, float activeChance) {
        super(system, 1f);
        this.minPts = minPts;
        this.maxPts = maxPts;
    ...
    protected CampaignFleetAPI spawnFleet(long seed) {
        ...
        fleet.addScript(new sanguinary_autonomist_defectors_AssignmentAI(fleet, system, null));
    ...
    public static void addSADInteractionConfig(CampaignFleetAPI fleet) {
        fleet.getMemoryWithoutUpdate().set(MemFlags.FLEET_INTERACTION_DIALOG_CONFIG_OVERRIDE_GEN,
                new sanguinary_autonomist_defectors_FleetInteractionConfigGen());
    }
