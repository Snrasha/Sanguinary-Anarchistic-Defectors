...
public class sanguinary_autonomist_defectors_effectsHook extends BaseEveryFrameCombatPlugin
{
  private CombatEngineAPI engine;
  
  public static void createFlakShockwave(Vector2f location)
  {
    LocalData localData = (LocalData)Global.getCombatEngine().getCustomData().get("sanguinary_autonomist_defectors_effectsHook");
    if (localData == null)
    {
      return;
    }
  ...
  public void advance(float amount, List<InputEventAPI> events)
  {
    ...
    LocalData localData = (LocalData)engine.getCustomData().get("sanguinary_autonomist_defectors_effectsHook");
    List<Shockwave> shockwaves = localData.shockwaves;
  ...
  {
    this.engine = engine;
    engine.getCustomData().put("sanguinary_autonomist_defectors_effectsHook", new LocalData());
  }
  ...
  public void renderInWorldCoords(ViewportAPI viewport)
  {
    ...
    {
      SpriteAPI waveSprite = Global.getSettings().getSprite("concussion", "sanguinary_autonomist_defectors_FlakWave");
      if (waveSprite != null)
      {
    ...
    for (tagPing ping : pings) {
      SpriteAPI waveSprite = Global.getSettings().getSprite("ping", "sanguinary_autonomist_defectors_tagPing");
      if (waveSprite != null)
      {
  ...
  {
    final List<sanguinary_autonomist_defectors_effectsHook.Shockwave> shockwaves = new LinkedList();
  
    final List<sanguinary_autonomist_defectors_effectsHook.tagPing> pings = new LinkedList();
