...
public class sanguinary_autonomist_defectors_DisruptSystemEffect extends BaseEveryFrameCombatPlugin {
    ...
    public void init(CombatEngineAPI engine) {
        this.engine = engine;
        sanguinary_autonomist_defectors_DisruptSystemEffect.telemetry = new java.util.HashMap();
    }
        ...
        if (!telemetry.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                if (remaining < 0.0F) {
                    ...
                    if (maxcompt < compt) {
                        sanguinary_autonomist_defectors_effectsHook.createPing(loc, vel);
                    }
